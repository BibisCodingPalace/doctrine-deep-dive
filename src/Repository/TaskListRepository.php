...
DQL;
        ...
        return $this->getEntityManager()
            ...
            ->enableResultCache(3600, 'frontpage_summarized')
            ->getResult();
    }
...
DQL;
        ...
        return $this->getEntityManager()
            ...
            ->enableResultCache(3600, 'frontpage_owned')
            ->getResult();
    }
    ...
    public function findListsContributedBy(User $user)
    {
        ...
        return $queryBuilder
            ...
            ->getQuery()
            ->enableResultCache(3600, 'frontpage_contributed')
            ->getResult();
    }
    ...
    public function findActive(User $owner)
    {
        return $this->createQueryBuilder('task_list')
            ...
            ->setParameter('owner', $owner)
            ->getQuery()
            ->enableResultCache(3600, 'frontpage_active')
            ->getResult();
    }
    ...
    public function findArchived(User $owner)
    {
        return $this->createQueryBuilder('task_list')
            ...
            ->setParameter('owner', $owner)
            ->getQuery()
            ->enableResultCache(3600, 'frontpage_archived')
            ->getResult();
    }
}